...
/**
 * Central password policy for every create / change / reset form.
 * Keep in sync with `server/src/lib/password-policy.ts`.
 */

const DEFAULT_MIN_LENGTH = 8;

export function resolvePasswordMinLength(
  raw: string | number | undefined = import.meta.env.VITE_PASSWORD_MIN_LENGTH,
): number {
